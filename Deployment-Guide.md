...
- Rename the Compost window to Client ID 
...
- Add New Step > Data Options > Compose 
- Rename the Compost window to Secret
- Input the Secret from app registration (Step 1)  

- Add New Step > Control Built-in > Condition 
...
- If False > Add a Action > Built-in Control > For each  
  - Under For each loop  
...
- Add New Step > Data Options > Compose 
- Rename the Compost window to NotificationURL 
...
- Add New Step > Data Options > Compose 
- Rename the Compost window to ExpiryTime 
- Input the value as Expression  
 ...
 - Add New Step > Data Options > Compose 
 - Rename the Compost window to SubscriptionBody 
...
- Add New Step > HTTP  
  ...
  - Input value of Secret as output from Compose  
